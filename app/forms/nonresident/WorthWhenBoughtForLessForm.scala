...
object WorthWhenBoughtForLessForm {
  val worthWhenBoughtForLessForm = Form(
    mapping(
      "worthWhenBoughtForLessValue" -> text
        .verifying(Messages("error.real"), mandatoryCheck)
        .verifying(Messages("error.real"), bigDecimalCheck)
        .transform(stringToBigDecimal, bigDecimalToString)
        .verifying(Messages("calc.worthWhenBoughtForLess.errorNegative"), isPositive)
        .verifying(Messages("calc.worthWhenBoughtForLess.errorDecimalPlaces"), decimalPlacesCheck)
