...
import forms.nonresident.PreviousLossOrGainForm.previousLossOrGainForm
import models.nonresident.PreviousLossOrGainModel
import uk.gov.hmrc.play.frontend.controller.FrontendController
import views.html.calculation.{nonresident => views}

object PreviousLossOrGainController extends PreviousLossOrGainController{
 val calcConnector = CalculatorConnector
}

trait PreviousLossOrGainController extends FrontendController with ValidActiveSession {
  val calcConnector: CalculatorConnector

  val previousLossOrGain = ValidateSession.async { implicit request =>
  ...
  val submitPreviousLossOrGain = TODO
}