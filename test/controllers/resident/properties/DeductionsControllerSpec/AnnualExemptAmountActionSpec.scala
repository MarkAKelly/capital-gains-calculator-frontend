...
class AnnualExemptAmountActionSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper with MockitoSugar {
  ...
  "Calling .submitAnnualExemptAmount from the DeductionsController" when {
    ...
    "a valid form is submitted with AEA of 1000 and zero taxable gain" should {
      ...
      lazy val taxYearModel = TaxYearModel("2015/16", true, "2015/16")
      lazy val lossesBroughtForwardModel = LossesBroughtForwardModel(false)
      lazy val target = setupTarget(Some(AnnualExemptAmountModel(1000)), gainModel, summaryModel, ChargeableGainResultModel(2000, 0, 1000, 0, 1000, BigDecimal(0), BigDecimal(0), Some(BigDecimal(0))), disposalDateModel = disposalDateModel, taxYearModel = taxYearModel, lossesBroughtForwardModel = lossesBroughtForwardModel)
    ...
    "a valid form is submitted with AEA of 0 and positive taxable gain" should {
      ...
      lazy val taxYearModel = TaxYearModel("2015/16", true, "2015/16")
      lazy val lossesBroughtForwardModel = LossesBroughtForwardModel(false)
      lazy val target = setupTarget(Some(AnnualExemptAmountModel(0)), gainModel, summaryModel, ChargeableGainResultModel(1000, 1000, 0, 0, 0, BigDecimal(0), BigDecimal(0), Some(BigDecimal(0))), disposalDateModel = disposalDateModel, taxYearModel = taxYearModel, lossesBroughtForwardModel = lossesBroughtForwardModel)
    ...
    "a valid form is submitted with AEA of 1000 and positive taxable gain" should {
      ...
      lazy val taxYearModel = TaxYearModel("2015/16", true, "2015/16")
      lazy val lossesBroughtForwardModel = LossesBroughtForwardModel(false)
      lazy val target = setupTarget(Some(AnnualExemptAmountModel(1000)), gainModel, summaryModel, ChargeableGainResultModel(2000, 1000, 1000, 0, 0, BigDecimal(0), BigDecimal(0), Some(BigDecimal(0))), disposalDateModel = disposalDateModel, taxYearModel = taxYearModel, lossesBroughtForwardModel = lossesBroughtForwardModel)
      lazy val request = fakeRequestToPOSTWithSession(("amount", "1000"))
      lazy val result = target.submitAnnualExemptAmount(request)
    ...
    "an invalid form is submitted" should {
      ...
      lazy val taxYearModel = TaxYearModel("2015/16", true, "2015/16")
      lazy val lossesBroughtForwardModel = LossesBroughtForwardModel(false)
      lazy val target = setupTarget(None, gainModel, summaryModel, ChargeableGainResultModel(2000, 1000, 1000, 0, 0, BigDecimal(0), BigDecimal(0), Some(BigDecimal(0))), disposalDateModel = disposalDateModel, taxYearModel = taxYearModel, lossesBroughtForwardModel = lossesBroughtForwardModel)
