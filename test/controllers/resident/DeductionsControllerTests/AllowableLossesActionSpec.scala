...
class AllowableLossesActionSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {

  "Calling .allowableLosses from the resident DeductionsController" should {
