...
//            document.select("#calculation-answers").text should include(Messages("calc.summary.calculation.details.totalGain"))
//          }
//
...
//            document.body().getElementById("nr:disposalDate-answer").text shouldBe "2 January 2017"
//          }
//
...
//            document.body().getElementById("nr:disposalValue-answer").text shouldBe "£1,250,000.00"
//          }
//
...
//            document.body().getElementById("nr:disposalCosts-answer").text shouldBe "£15,000.00"
//          }
//        }
        ...
        "have a 'Deductions details' section that" should {
          ...
          "the value of allowable losses should be £0" in {
            document.body().getElementById("nr:allowableLosses-answer").text shouldBe "£0.00"
          }
          ...
          "the PRR claimed question's answer should be '£0.00'" in {
            document.body().getElementById("nr:otherReliefsRebased-answer").text shouldBe "£0.00"
          }
