...
class PersonalAllowanceViewSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {
  ...
  val postAction = controllers.resident.properties.routes.IncomeController.submitPersonalAllowance()
  ...
  "Personal Allowance view" when {
    ...
    "supplied with a 2015/16 tax year" should {
      ...
      lazy val view = views.personalAllowance(personalAllowanceForm(), taxYearModel, BigDecimal(10600), "home", postAction, Some("back-link"), JourneyKeys.properties)(fakeRequest)
      ...
      "Personal Allowance view with stored values" should {
        ...
        lazy val view = views.personalAllowance(form, taxYearModel, BigDecimal(10600), "home", postAction, Some("back-link"), JourneyKeys.properties)(fakeRequest)
        lazy val doc = Jsoup.parse(view.body)
    ...
    "supplied with a 2016/17 tax year" should {
      ...
      lazy val view = views.personalAllowance(personalAllowanceForm(), taxYearModel, BigDecimal(11000), "home", postAction, Some("back-link"), JourneyKeys.properties)(fakeRequest)
      lazy val doc = Jsoup.parse(view.body)
      lazy val h1Tag = doc.select("H1")
    ...
    "Personal Allowance View with form with errors" which {
      ...
      "is due to mandatory field error" should {
        ...
        lazy val view = views.personalAllowance(form, taxYearModel, BigDecimal(11000), "home", postAction, Some("back-link"), JourneyKeys.properties)(fakeRequest)
        lazy val doc = Jsoup.parse(view.body)
