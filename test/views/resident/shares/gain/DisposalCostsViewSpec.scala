...
//        backLink.attr("href") shouldBe controllers.resident.shares.routes.GainController.disposalValue().toString
//      }
//    }
//
...
//
//      s"has the action '${controllers.resident.shares.routes.GainController.submitDisposalCosts().toString}'" in {
//        form.attr("action") shouldBe controllers.resident.shares.routes.GainController.submitDisposalCosts().toString
//      }
//
