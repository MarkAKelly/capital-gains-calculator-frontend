...
//
//    "for the option 'Yes'" should {
//      lazy val view = views.didYouInheritThem(didYouInheritThemForm.fill(DidYouInheritThemModel(true)))(fakeRequest)
//      lazy val doc = Jsoup.parse(view.body)
//      lazy val YesRadioOption = doc.select(".block-label[for=wereInherited-yes]")
//
...
//
//    "for the option 'No'" should {
//      lazy val view = views.didYouInheritThem(didYouInheritThemForm.fill(DidYouInheritThemModel(false)))(fakeRequest)
//      lazy val doc = Jsoup.parse(view.body)
//      lazy val NoRadioOption = doc.select(".block-label[for=wereInherited-no]")
//
//      "have the option auto-selected" in {
...
//    lazy val view = views.didYouInheritThem(form)(fakeRequest)
//    lazy val doc = Jsoup.parse(view.body)
//
