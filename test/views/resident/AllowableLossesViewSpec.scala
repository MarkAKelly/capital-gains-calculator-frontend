...
class AllowableLossesViewSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {
  ...
  "Allowable Losses view" should {
    ...
    lazy val view = views.allowableLosses(allowableLossesForm, TaxYearModel("2015/16", true, "2015/16"), postAction, backLink, "home")(fakeRequest)
  ...
  "Allowable Losses view with pre-selected values" should {
    ...
    lazy val view = views.allowableLosses(form, TaxYearModel("2015/16", true, "2015/16"), postAction, backLink, "home")(fakeRequest)
    lazy val doc = Jsoup.parse(view.body)
