...
class NoPrrReliefsValueViewSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {

  "Reliefs Value view" should {

    lazy val form = reliefsValueForm.bind(Map("amount" -> "10"))
    lazy val view = views.noPrrReliefsValue(form, "home-link")(fakeRequest)
