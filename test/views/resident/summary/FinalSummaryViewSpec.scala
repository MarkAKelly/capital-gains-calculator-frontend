...
//import models.resident.{AnnualExemptAmountModel, _}
//import org.jsoup.Jsoup
//import uk.gov.hmrc.play.test.{UnitSpec, WithFakeApplication}
//import views.html.calculation.resident.{summary => views}
//import _root_.views.html.calculation.resident
...
//
//    lazy val view = views.finalSummary(gainAnswers, deductionAnswers, results, backLink)(fakeRequestWithSession)
